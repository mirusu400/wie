//! Database implementation copied from wie_cli/src/database.rs.
//! Records under `<ProjectDirs::data_dir>/<app_id>/db/<name>/<record_id>`.
...
impl Database {
    ...
    fn find_empty_record_id(&self) -> RecordId {
        let mut record_id = 1u32; // midp expects first record id = 1
        loop {
